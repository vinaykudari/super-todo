...
BROWSER_DEFAULT_VIEWPORT_WIDTH = int(os.getenv("BROWSER_DEFAULT_VIEWPORT_WIDTH", "390"))
BROWSER_DEFAULT_VIEWPORT_HEIGHT = int(os.getenv("BROWSER_DEFAULT_VIEWPORT_HEIGHT", "844"))
BROWSER_DEFAULT_DEVICE_SCALE_FACTOR = float(os.getenv("BROWSER_DEFAULT_DEVICE_SCALE_FACTOR", "2.0"))
BROWSER_MOBILE_BY_DEFAULT = os.getenv("BROWSER_MOBILE_BY_DEFAULT", "true").lower() == "true"
